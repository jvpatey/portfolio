      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 sm:flex-row sm:items-end sm:justify-between sm:gap-8">
        ...
        <div className="flex shrink-0 gap-4 sm:justify-end sm:gap-5">
          <a
            ...
            className="rounded-md text-slate-400 transition-colors hover:text-[var(--accent-primary)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--hero-base)]"
            aria-label="GitHub"
          >
