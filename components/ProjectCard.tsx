...
export default function ProjectCard({
  ...
  return (
    <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center">
      {/* Content */}
      <div
        className={imagePosition === "left" ? "order-1 md:order-2" : "order-1"}
      >
        <p className="text-blue-400 text-xs sm:text-sm mb-2">
          Featured Project
        </p>
        <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">{title}</h3>
        <div className="bg-slate-800 p-4 sm:p-6 rounded-lg mb-3 sm:mb-4">
      ...
      {/* Image */}
      <div
        className={imagePosition === "left" ? "order-2 md:order-1" : "order-2"}
      >
        {renderImage()}
      </div>
    </div>
